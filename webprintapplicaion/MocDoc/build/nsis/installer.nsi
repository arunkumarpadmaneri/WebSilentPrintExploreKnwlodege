!define PRODUCT_NAME "WSP"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.3"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "WSP_1.0.exe"
!define PRODUCT_ICON "WSP.ico"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "WSP"
...
!define MUI_ICON "WSP.ico"
!define MUI_UNICON "WSP.ico"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\WSP.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\WSP.launch.pyw"' "$INSTDIR\WSP.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\WSP.launch.pyw"
    Delete "$INSTDIR\WSP.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\WSP.lnk"
  RMDir $INSTDIR
